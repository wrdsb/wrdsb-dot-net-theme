...
namespace WRDSB_Dot_Net_Template
{
    public class LdapAuthentication
    {
        ...
        public String GetEIN()
        {
            ...
            {
                SearchResult result = search.FindOne();
                ein = result.Properties["homePhone"][0].ToString();
            }
            catch (Exception ex)
            {
                throw new Exception("Error obtaining ein number name. " + ex.Message);
            }
            return ein;
        }
        ...
        public String GetEmail()
        {
            ...
            {
                throw new Exception("Error obtaining email. " + ex.Message);
            }
            return email;
        }
        ...
        public String GetGroupCode()
        {
            ...
            {
                SearchResult result = search.FindOne();
                groupCode = result.Properties["company"][0].ToString();
            }
            catch (Exception ex)
            {
                throw new Exception("Error obtaining emp group code. " + ex.Message);
            }
            return groupCode;
        }
